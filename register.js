...
async function register(){
    ...
    created_time:time,updated_time:time,u_ph:ph_no,u_address:address,u_pass:u_pass,u_mail:email,u_firstname:firstname,u_lastname:lastname,created_date:date,updated_date:date})
    console.log(error)
}
